          ...
          <form action="dashboard.php" method="post" enctype="multipart/form-data">
            <table class="update-form table">
              ...
              <tr class="form-file">
                ...
                <td>
                  <div class="update-img">
                    <img src="<?php print h(BRANDS_IMG_DIR . $record->img1); ?>">
                  </div>
              ...
              <tr class="form-file">
                ...
                <td>
                  <div class="update-img">
                    <img src="<?php print h(BRANDS_IMG_DIR . $record->img2); ?>">
                  </div>
                  <div class="img-button">
              ...
              <tr class="form-file">
                ...
                <td>
                  <div class="update-img">
                    <img src="<?php print h(BRANDS_IMG_DIR . $record->img3); ?>">
                  </div>
                  <div class="img-button">
              ...
              <tr class="form-file">
                ...
                <td>
                  <div class="update-img">
                    <img src="<?php print h(BRANDS_IMG_DIR . $record->img4); ?>">
                  </div>
                  <div class="img-button">
              ...
              <tr class="form-file">
                ...
                <td>
                  <div class="update-img">
                    <img src="<?php print h(BRANDS_IMG_DIR . $record->img5); ?>">
                  </div>
                  <div class="img-button">
              ...
              <tr class="form-file">
                ...
                <td>
                  <div class="update-img">
                    <img src="<?php print h(BRANDS_IMG_DIR . $record->img6); ?>">
                  </div>
                  <div class="img-button">
              ...
              <tr class="form-file">
                ...
                <td>
                  <div class="update-img">
                    <img src="<?php print h(BRANDS_IMG_DIR . $record->img7); ?>">
                  </div>
                  <div class="img-button">
              ...
              <tr class="form-file">
                ...
                <td>
                  <div class="update-img">
                    <img src="<?php print h(BRANDS_IMG_DIR . $record->img8); ?>">
                  </div>
                  <div class="img-button">
