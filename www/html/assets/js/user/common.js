...
// in-page　検索窓の設定------------------------------------------
//検索窓を押した時には
$("#search-wrap-in-page").click(function () {
  $('#search-text-in-page').focus();//テキスト入力のinputにフォーカス
});
...
//スマホ用：スライダーをタッチしても止めずにスライドをさせたい場合
$('.sub-slider').on('touchmove', function(event, slick, currentSlide, nextSlide){
...
//スマホ用：スライダーをタッチしても止めずにスライドをさせたい場合
$('.shrot-slider').on('touchmove', function(event, slick, currentSlide, nextSlide){
...
//スマホ用：スライダーをタッチしても止めずにスライドをさせたい場合
$('.brand-image-slider').on('touchmove', function(event, slick, currentSlide, nextSlide){
...
$('.item-photo').on('beforeChange', function(event, slick, currentSlide, nextSlide) {
