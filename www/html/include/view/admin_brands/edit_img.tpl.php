    ...
    <div id="title">
      <div class="container">  
        ...
        <nav class="title-nav">
          ...
          <span>&gt;</span>
          <span>
            <a href="dashboard.php?module=admin_brands&action=edit_img&brand_id=<?php print h($record->brand_id); ?>">ブランド画像</a>
          </span>
        </nav>
        ...
        <div class="update-form">
          <form action="dashboard.php" method="post" enctype="multipart/form-data">
            <table class="update-form table">
              ...
              <tr class="form-text">
                <th>
                  <label for="brand_name">名前：</label>
                </th>
                <td>
                  <span class="raw_data"><?php print h($record -> brand_name); ?></span>
                </td>
              </tr>
              <!--画像1-->
              <tr class="form-file">
              ...
              <tr class="form-file">
                ...
                <td>
                  <div class="update-img">
                    <img src="<?php print h('./include/images/brands/img/' .$record->img2); ?>">
                  </div>
                  <div class="img-button">
              ...
              <tr class="form-file">
                ...
                <td>
                  <div class="update-img">
                    <img src="<?php print h('./include/images/brands/img/' .$record->img3); ?>">
                  </div>
                  <div class="img-button">
              ...
              <tr class="form-file">
                ...
                <td>
                  <div class="update-img">
                    <img src="<?php print h('./include/images/brands/img/' .$record->img4); ?>">
                  </div>
                  <div class="img-button">
              ...
              <tr class="form-file">
                ...
                <td>
                  <div class="update-img">
                    <img src="<?php print h('./include/images/brands/img/' .$record->img5); ?>">
                  </div>
                  <div class="img-button">
              ...
              <tr class="form-file">
                ...
                <td>
                  <div class="update-img">
                    <img src="<?php print h('./include/images/brands/img/' .$record->img6); ?>">
                  </div>
                  <div class="img-button">
              ...
              <tr class="form-file">
                ...
                <td>
                  <div class="update-img">
                    <img src="<?php print h('./include/images/brands/img/' .$record->img7); ?>">
                  </div>
                  <div class="img-button">
              ...
              <tr class="form-file">
                ...
                <td>
                  <div class="update-img">
                    <img src="<?php print h('./include/images/brands/img/' .$record->img8); ?>">
                  </div>
                  <div class="img-button">
