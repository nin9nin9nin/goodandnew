      ...
      <div class="container">
        ...
        <div class="paginations">
            ...
            <?php if ($paginations['page_id'] !== '1') { ?>
                <a href="dashboard.php?module=admin_events&action=search&page_id=<?php print h($paginations['prev_page']); ?>" class="page_feed">&laquo;</a>
            <?php } else { ?>
            ...
            <?php foreach ($paginations['page_range'] as $num) { ?>
                ...
                <?php } else { ?>
                    <a href="dashboard.php?module=admin_events&action=search&page_id=<?php print h($num); ?>" class="page_number"><?php print h($num); ?></a>
                <?php } ?>
            <?php } ?>
            <!-- 進む -->
            <?php if($paginations['page_id'] < $paginations['page_total']) { ?>
                <a href="dashboard.php?search%5Bkeyword%5D=sample&module=admin_events&action=search&page_id=<?php print h($paginations['next_page']); ?>" class="page_feed">&raquo;</a>
            <?php } else { ?>
